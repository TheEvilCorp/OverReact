...
module.exports = function(req, res, next){
	...
	promises.push(fs.writeFileAsync(`./zips/${req.body.hash}/${req.body.projectName}/index.html`, file));
	//create package.json
	...
	promises.push(fs.writeFileAsync(`./zips/${req.body.hash}/${req.body.projectName}/package.json`, file));
	...
	if(req.body.task !== 'none') {
		...
		promises.push(fs.writeFileAsync(`./zips/${req.body.hash}/${req.body.projectName}/${req.body.task === 'gulp' ? 'gulp' : 'grunt'}file.js`, file));
	}
	...
	if(req.body.server !== 'none') {
		...
		promises.push(fs.writeFileAsync(`./zips/${req.body.hash}/${req.body.projectName}/server/server.js`, file));
	}
